<script setup lang="ts">
    ...
    const pageMeta = {
      header: {
        name: "ANIMEX",
        description: "次世代アニメストリーミング • Next-Gen Anime Streaming",
      },
      showHeader: true,
    };
    ...
    onMounted(async () => {
      try {
        ...
        if (data.success && data.data.spotlight) {
          animeItems.value = data.data.spotlight;
        }
      } catch (error) {
    ...
    onMounted(() => {
      intervalId = setInterval(() => {
        if (animeItems.value.length > 0) {
          currentSlide.value = (currentSlide.value + 1) % animeItems.value.length;
        }
      }, 5000);
    });
      ...
      <div class="min-h-screen p-10">
        <div class="max-w-7xl mx-auto">
          ...
          <div v-else class="spotlight-container">
            ...
            <div class="featured-anime" v-for="(item, index) in animeItems" :key="item.id" 
              ...
              <div class="anime-content">
                ...
                <div class="action-buttons">
                  <UButton color="primary" size="lg" icon="i-heroicons-play">
                    Watch Now
                  </UButton>
            ...
            <div class="carousel-indicators">
              <button
                v-for="(item, index) in animeItems"
                :key="index"
          ...
          <section class="mt-12">
            ...
            <div v-else class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
              <div
                v-for="item in animeItems.slice(0, 10)"
                :key="item.id"
              ...
              >
                <div class="relative overflow-hidden rounded-lg shadow-lg transition-transform duration-300 hover:scale-105">
                  ...
                  <!-- Overlay on hover -->
                  <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/90 via-black/70 to-transparent p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
